...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-amr-010-0205-questions-in-geometric-group-theory-q-0c999575",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-010-0205-a79aced9fca8",
        "url": "https://www.unsolvedmath.com/problems/AMR-010-0205"
      }
    ],
    "statement": {
      "language": "en",
      "text": "(Exercise in [BGS85, p.2]) Take a closed surface S of genus ≥2. Let V = S × S and let Σ ⊂V denote the diagonal. Let ˜V be a nontrivially ramified finite cover of V along Σ. Then ˜V has a natural piecewise hyperbolic CAT(0) metric. Show that ˜V admits no C2-smooth Riemannian metric with curvature K ≤0.",
      "version": 1
    },
    "title": "Questions in Geometric Group Theory — Q 2.5",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "7c81a96484c48e502da051e5e29a573c4d94021b4c2022da3e7aca0e9f8e4470"
}
```
